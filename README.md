...
- Le FootballDle,  où il faut trouver un joueur de foot en faisant des essais.

Une partie Quiz avec :
- Une page Host pour afficher les questions et donner les points.
- Une page Joueur pour répondre aux questions.
- Une page de création et gestion des questions du quiz.
